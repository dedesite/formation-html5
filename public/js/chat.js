...
function geoLocaliseProfile() {
    ...
    navigator.geolocation.getCurrentPosition((pos) => {
        ...
        const osmUrl = "https://nominatim.openstreetmap.org/reverse";
        $.getJSON(osmUrl, {
...
function connectToChat() {
    const ws = new window.WebSocket(`ws://${window.location.hostname}:3000/ws`);
...
$("main").workflow({manageHistory: true, handleHashChange: true});
